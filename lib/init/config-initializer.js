...
import { info, error } from "../shared/logging.js";
...
function promptUser() {
    ...
    if (!packageJsonExists) {
        error("Cannot initialize ESLint outside a node project");
        exit();
    }
    return enquirer.prompt([
        {
        ...
        },
        {
            ...
            skip() {
                return !(this.state.answers.source === "guide" && packageJsonExists);
            },
            result(input) {
                return this.skipped ? null : input;
            }
        ...
        },
        {
            ...
            initial: 1,
            skip() {
                return !(this.state.answers.source === "guide" && packageJsonExists && hasESLintVersionConflict(this.state.answers));
            },
            result(input) {
                return this.skipped ? null : input;
            }
        ...
        if (earlyAnswers.purpose !== "style") {
            ...
            return askInstallModules(modules, packageJsonExists)
        ...
        return enquirer.prompt([
            ...
            return askInstallModules(modules, packageJsonExists).then(() => writeFile(config, earlyAnswers.format));
        });
    });
}
