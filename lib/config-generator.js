...
export class ConfigGenerator {
    ...
    calc() {
        ...
        if (this.answers.config?.packageName === "eslint-config-airbnb-base" && this.answers.framework === "react") {
            this.answers.config.packageName = "eslint-config-airbnb";
        ...
        if (this.answers.config && this.answers.language === "typescript") {
