...
describe("generate config for esm projects", () => {
	...
	const inputs = [
		{
			name: "esm-json-syntax",
			answers: { languages: ["json"], purpose: "syntax" },
		},
		{
			name: "esm-json-problems",
			answers: { languages: ["json"], purpose: "problems" },
		},
		{
			name: "esm-json5-syntax",
			answers: { languages: ["json5"], purpose: "syntax" },
		},
		{
			name: "esm-json5-problems",
			answers: { languages: ["json5"], purpose: "problems" },
		},
		{
			name: "esm-jsonc-syntax",
			answers: { languages: ["jsonc"], purpose: "syntax" },
		},
		{
			name: "esm-jsonc-problems",
			answers: { languages: ["jsonc"], purpose: "problems" },
		},
		{
			name: "esm-markdown-commonmark-syntax",
			answers: {
				languages: ["md"],
				mdType: "commonmark",
				purpose: "syntax",
		...
		{
			name: "esm-markdown-commonmark-problems",
			answers: {
				languages: ["md"],
				mdType: "commonmark",
				purpose: "problems",
		...
		{
			name: "esm-markdown-gfm-syntax",
			answers: { languages: ["md"], mdType: "gfm", purpose: "syntax" },
		},
		{
			name: "esm-markdown-gfm-problems",
			answers: { languages: ["md"], mdType: "gfm", purpose: "problems" },
		},
		{
			name: "esm-javascript-json-problems",
			answers: {
		...
		{
			name: "esm-css-syntax",
			answers: { languages: ["css"], purpose: "syntax" },
		},
		{
			name: "esm-css-problems",
			answers: { languages: ["css"], purpose: "problems" },
		},
		{
			name: "esm-configfile-js",
			answers: {
				...
				framework: "none",
				useTs: true,
				configFileLanguage: "js",
				env: ["node"],
			},
		},
		{
			name: "esm-configfile-ts",
			answers: {
				languages: ["javascript"],
				purpose: "problems",
				moduleType: "esm",
				framework: "none",
				useTs: true,
				configFileLanguage: "ts",
				addJiti: false,
				env: ["node"],
			},
		},
		{
			name: "esm-configfile-ts-jiti",
			answers: {
				languages: ["javascript"],
				purpose: "problems",
				moduleType: "esm",
	...
	inputs.forEach(item => {
		test(`${item.name}`, async () => {
			...
			const expectedExtension =
				item.answers.configFileLanguage === "ts" ? "ts" : "js";

			expect(generator.result.configFilename).toBe(
				`eslint.config.${expectedExtension}`,
			);
			expect(generator.packageJsonPath).toBe(
...
describe("generate config for cjs projects", () => {
	...
	inputs.forEach(item => {
		test(`${item.name}`, async () => {
			...
			const expectedExtension =
				item.answers.configFileLanguage === "ts" ? "mts" : "mjs";
